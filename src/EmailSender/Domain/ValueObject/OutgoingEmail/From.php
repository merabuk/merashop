...
use App\EmailSender\Domain\Exception\OutgoingEmail\InvalidOutgoingEmailFromException;
...
final class From implements \Stringable
{
    ...
    /**
     * @throws InvalidOutgoingEmailFromException
     */
    public function __construct(string $email)
    {
        try {
            ...
            throw InvalidOutgoingEmailFromException::fromBaseException($e);
        }
    }
