...
class JwtConfigFactory
{
    ...
    {
        $privateKey = TypeCaster::castToNonEmptyString(string: $privateKey, message: 'Giving private key is empty');
        $publicKey = TypeCaster::castToNonEmptyString(string: $publicKey, message: 'Giving public key is empty');
