    ...
    <div class="w-full">
        ...
        <div class="relative">
            <textarea
                ...
                :maxlength="maxLength"
                :rows="rows"
                class="w-full px-4 py-2 border rounded-lg transition-all duration-200 bg-white shadow-xs outline-none focus:outline-none resize-y min-h-[100px]"
                :class="[error
