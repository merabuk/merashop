...
use App\Catalog\Application\Service\Product\AttributeValue\UrlAttributeValueProvider;
...
final class UrlAttributeValueProviderTest extends BaseUnitTest
{
    private const TypeEnum TYPE = TypeEnum::Url;
    ...
    public function testItHandleCorrectly(): void
    {
        ...
        self::assertInstanceOf(UrlValue::class, $value);
    ...
    private static function getData(string $value = 'https://example.com'): UrlAttributeValueData
    {
        return new UrlAttributeValueData(value: $value);
    }

    private function createProvider(): UrlAttributeValueProvider
    {
        return new UrlAttributeValueProvider();
    }
}
