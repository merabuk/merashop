...
use App\Catalog\Application\Service\Product\AttributeValue\BooleanAttributeValueProvider;
...
final class BooleanAttributeValueProviderTest extends TestCase
{
    ...
    private static function getData(bool $value = true): BooleanAttributeValueData
    {
        return new BooleanAttributeValueData(value: $value);
    }

    private function createProvider(): BooleanAttributeValueProvider
    {
        return new BooleanAttributeValueProvider();
    }
}
