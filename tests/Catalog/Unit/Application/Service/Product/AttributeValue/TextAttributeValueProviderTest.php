...
use App\Catalog\Application\Service\Product\AttributeValue\TextAttributeValueProvider;
...
final class TextAttributeValueProviderTest extends TestCase
{
    ...
    private static function getData(): TextAttributeValueData
    {
        return new TextAttributeValueData(translations: [
            'en' => 'Test text value',
            'uk' => 'Тестове текстове значення',
        ]);
    }

    private function createProvider(): TextAttributeValueProvider
    {
        return new TextAttributeValueProvider();
    }
}
