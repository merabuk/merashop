...
use App\Catalog\Application\Service\Product\AttributeValue\ColorAttributeValueProvider;
...
final class ColorAttributeValueProviderTest extends BaseUnitTest
{
    private const TypeEnum TYPE = TypeEnum::Color;
    ...
    private static function getData(string $value = '#AABBCC'): ColorAttributeValueData
    {
        return new ColorAttributeValueData(value: $value);
    }

    private function createProvider(): ColorAttributeValueProvider
    {
        return new ColorAttributeValueProvider();
    }
}
